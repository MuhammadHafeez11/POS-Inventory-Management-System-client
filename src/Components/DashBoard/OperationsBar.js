...
const OperationsBar = () => {
  ...
  return (
    <>
      <div className="Main-operationDiv">
      {(isAdministrator || isSuperAdmin || isAdmin || isSalesman) && (
          <div className={`invoices-section ${colorTheme}`}>
            ...
            <div className="section-content">
              ...
              {(isAdmin || isAdministrator || isSuperAdmin) && (
                <PagesButton
                  props={{
                    linkName: t("commission"),
                    linkIcon: <MonetizationOnOutlinedIcon />,
                    linkNavigation: "/paidEmployeCommission",
                  }}
                />
              )}
            </div>
        ...
        {isAdmin || isSalesman  ? (
          <div className="operation-section">
            ...
            <div className="section-content">
              <PagesButton
                props={{
                  linkName: t("DashSalePendings"),
                  linkIcon: <LocalOfferOutlinedIcon />,
                  linkNavigation: "/tempSalePendings",
                }}
              />
              {isAdmin  ? (
                <>
                  <PagesButton
                    props={{
                      linkName: t("DashPurchasePendings"),
                      linkIcon: <PaymentsIcon />,
                      linkNavigation: "/tempPurchasePendings",
                    }}
                  />

                  <PagesButton
                    props={{
                      linkName: t("dashTransferPendings"),
                      linkIcon: <MoveUpIcon />,
                      linkNavigation: "/tempTransferPendings",
                    }}
                  />
                </>
              ) : (
        ...
        {isAdmin || isSalesman || isAdministrator || isSuperAdmin ? (
          <div className="operation-section">
            <span className="operationTxt">{t("dashExpenses")}</span>
            <div className="section-content">
              <PagesButton
                props={{
                  linkName: t("Expense"),
                  linkIcon: <LocalOfferOutlinedIcon />,
                  linkNavigation: "/expensee",
                }}
              />
              {isAdmin || isSuperAdmin || isAdministrator ? (
                <>
                  <PagesButton
                    props={{
                      linkName: t("expenseType"),
                      linkIcon: <PaymentsIcon />,
                      linkNavigation: "/expense",
                    }}
                  />
                </>
              ) : (
...
{isAdmin || isSalesman || isAdministrator || isSuperAdmin ? (
          <div className="operation-section">
            <span className="operationTxt">{t("dashCommission")}</span>
            <div className="section-content">
              <PagesButton
                props={{
                  linkName: t("commissionReport"),
                  linkIcon: <LocalOfferOutlinedIcon />,
