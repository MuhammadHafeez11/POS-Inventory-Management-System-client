          ...
          <>
            <div className="contentt-box">
              ...
              <div className="excelDiv">
                {/* {pctCodeCompany !== "No Record Found" && pctCodeCompany?.length > 0 && downloadXLS && (
                  <>
                    <TableToExcel
                ...
                {addCompanyPermission && (
                  <Button
                    ...
                    onClick={() => {
                      navigate("/FBR-addcompany", {state: "/FBR-Company"});
                    }}
                  >
                    {t("add-company")}
                  </Button>
