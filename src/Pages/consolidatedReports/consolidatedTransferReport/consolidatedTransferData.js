...
let totalQuantity;
const ConsolidatedTransferData = ({ tableData, selectedShop }) => {
    ...
    <div style={{display: "flex", flexDirection: "column", justifyContent: "space-between"}} className="consolidatedDatesData">
      ...
      {!dataLoading && (<>
                <div style={{display: "flex", flexDirection: "column", justifyContent: "space-between"}} className="InvoiceThirdCont">
                  <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between", }} className="consolidateTransferLaserdivs">
                  <h5>Record Of:&nbsp;</h5>
                  <p>{selectedShop}</p>
                  </div>
                  <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between", }} className="consolidateTransferLaserdivs">
