...
import { deletePCTCodeCompany, getPCTCodeCompany } from "../../../../../actions/pctCodeAction";
let isCalledd = "false";
const CompanyTable = () => {
  //for Scrolling
  ...
  const deleteComp = async (id) => {
    swal
      ...
      .then(async (result) => {
        if (result.value) {
          const response = await deletePCTCodeCompany(id);
          if (
            response?.data?.error ===
    ...
    <>
      {/* <div className={`company ${colorTheme}`}> */}
        ...
        <div className="table-container">
          {!pctCodeCompanyLoading && pctCodeCompany !== "No Record Found" ? (
            <TableComponentId
              data={pctCodeCompany}
              columns={columns}
              actions={actions}
